...
Polaris extends the well known pivot table \ref{citation} interface to display information visually. It acts as an interface for large multi-dimensional databases. The visualizations acts as interactive query builders that allow users to explore large datasets quite rapidly. First published in 2000 it has evolved into Tableau, a commercial visualizations product. 

Polaris consists of two main components. A graphic generator and a database query generator.
