...
\end{itemize}
\paragraph{Functionality.} Overall AC\lightning{}DV meets the requirements set out in Table \ref{feature_matrix} \todo{Make sure these are explicitly stated as requirements in design}. A brief discussion of each requirement is given below:
