...
The first two goals are examined at length below in Section \ref{eval_of_req}. The extent to which visualizations can be generated given only an input dataset is addressed in section \ref{Discussion} along with the research question. The final goal is addressed in Section \ref{future}.
